    ...
    <QueryClientProvider client={queryClient}>
      <SiteLayoutContext.Provider value={{ sidebarOpen, setSidebarOpen }}>
        <div className="flex flex-col min-h-screen">
          <header className="bg-gradient-to-r from-[var(--primary)] to-[var(--secondary)] shadow px-4 py-2 flex items-center gap-1.5">
            <h1 className="text-lg font-bold text-[var(--text-primary)]">AI Text Generator</h1>
            <div className="relative group mr-auto">
              ...
              <span className="absolute left-full top-1/2 -translate-y-1/2 ml-2 px-2 py-1 text-sm text-red bg-gray-800 rounded opacity-0 group-hover:opacity-100 transition-opacity duration-300 whitespace-nowrap z-10">
          ...
          <footer className="bg-gradient-to-r from-[var(--primary)] to-[var(--secondary)] py-4 text-center text-sm text-[var(--text-primary)]">
